...
conda run -n asm_megahit bash -c "source code/analysis/time/run_with_time.sh code/assembly/megahit/megahit_sr-marine_sediment.sh" | tee data/analysis/megahit/sr-marine_sediment/log_assemble_megahit_sr-marine_sediment.log
