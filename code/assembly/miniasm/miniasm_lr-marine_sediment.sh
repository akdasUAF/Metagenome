...
./tools/processing/gfastats/build/bin/gfastats data/MAG/miniasm/lr-marine_sediment/polished_assembly_minimap_lr-marine_sediment.gfa -o data/MAG/miniasm/lr-marine_sediment/polished_assembly_minimap_lr-marine_sediment.fasta
