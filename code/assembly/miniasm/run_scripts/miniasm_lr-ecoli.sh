...
bash code/processing/convert_gfa_to_fasta.bash data/MAG/miniasm/lr-ecoli/polished_assembly_minimap_lr-ecoli.gfa data/MAG/miniasm/lr-ecoli/polished_assembly_minimap_lr-ecoli.fasta
