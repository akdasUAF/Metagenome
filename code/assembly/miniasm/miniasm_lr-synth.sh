...
./tools/processing/gfastats/build/bin/gfastats data/MAG/miniasm/lr-synth/polished_assembly_minimap_lr-synth.gfa -o data/MAG/miniasm/lr-synth/polished_assembly_minimap_lr-synth.fasta
