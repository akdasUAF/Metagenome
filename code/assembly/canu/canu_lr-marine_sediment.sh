...
./tools/assemblers/canu-2.2/bin/canu -p lr-marine_sediment -d data/MAG/canu/lr-marine_sediment/ genomeSize=7000 -nanopore data/raw/lr-marine_sediment/SRR27145287/SRR27145287.fastq 
