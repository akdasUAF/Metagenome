...
conda run -n asm_flye bash -c "source code/analysis/time/run_with_time.sh code/assembly/flye/flye_lr-marine_sediment.sh" | tee data/analysis/flye/lr-marine_sediment/log_assemble_flye_lr-marine_sediment.log
