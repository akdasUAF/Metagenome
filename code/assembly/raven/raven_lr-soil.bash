...
mkdir -p data/process/raven/lr-soil/logs
touch data/process/raven/lr-soil/logs/log_raven_lr-soil.txt
{
...
} > data/process/raven/lr-soil/logs/log_raven_lr-soil.txt
