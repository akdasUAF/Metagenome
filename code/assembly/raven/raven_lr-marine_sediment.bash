...
mkdir -p data/process/raven/lr-marine_sediment/logs
touch data/process/raven/lr-marine_sediment/logs/log_raven_lr-marine_sediment.txt
{
flye --meta --nano-raw  data/process/flye/lr-marine_sediment --threads 12
...
} > data/process/raven/lr-marine_sediment/logs/log_raven_lr-marine_sediment.txt
