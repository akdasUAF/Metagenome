...
conda run -n asm_raven bash -c "source run_with_time.sh code/assembly/raven/raven_lr-marine_sediment.sh" | tee data/analysis/raven/lr-marine_sediment/log_assemble_raven_lr-marine_sediment.log
