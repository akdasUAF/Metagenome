...
MAG_output="data/MAG/megahit/sr-bmock/"
...
command="abyss-pe k=41 name=abyss_sr-bmock B=500G j = 24 \
	in='data/process/sr-bmock/trimmed/sr-bmock_trimmed_SRR8073716_1.fastq.gz data/process/sr-bmock/trimmed/sr-bsc_trimmed_SRR8073716_2.fastq.gz \
